...
public class MathCheck {
    public static void main(String[] args) throws IOException{
        FileReader fileReader = new FileReader("C:\\Users\\yaros\\SIAOD4\\src\\Math.txt");
        ...
        while(fileReader.ready() && flag) {
            ...
            if (t==')'){
                char s0= (char) stack.deleteElement();
                char s1= (char) stack.deleteElement();
